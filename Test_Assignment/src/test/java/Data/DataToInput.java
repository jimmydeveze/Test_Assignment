...
public class DataToInput
{
    ...
    public String newTitle = "Lorem";
    public String newSubTitle = "Why do we use it?";
    public String newbody = "It is a long established fact that a reader will be distracted by the readable content of " +
